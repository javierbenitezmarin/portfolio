...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Javier!",
    'An AI Engineer building Generative AI and Computer Vision systems',
    'that run in production. I work across the whole stack, from infra',
    'and CI/CD up to LLM pipelines, RAG, and multi-agent orchestration.',
  ],
  skills: () => [
    'Technical Skills:',
    '  AI & Agents:  LLM pipelines, LangChain, LangGraph, Snowflake Cortex',
    '  Vision/Docs:  Multimodal extraction, fraud detection, OCR, Azure DI',
    '  Infra/MLOps:  AWS, GCP, Docker, GitHub Actions, Langfuse, FastAPI',
    '  Data:         MongoDB, Chroma, Pinecone, SQL',
    '  Languages:    Python, TypeScript, SQL',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. DocFraud - multimodal document fraud detection',
    '  2. Conversational Analytics Agent (Snowflake Cortex)',
    '  3. Autonomous multi-agent content pipeline',
    '',
    'Open the projects/ folder for more details.',
  ],
  contact: () => [
    'Contact Information:',
    '  Email:    javierbenitezmarin@gmail.com',
    '  GitHub:   github.com/javierbenitezmarin',
    '  LinkedIn: linkedin.com/in/javier-benitez-marin',
  ],
  themes: () => [
    'Available themes:',
  ...
  whoami: () => ['visitor@portfolio ~ exploring Javier\'s work'],
  ls: () => ['AGENTS.md', 'skills/', 'experience.md', 'projects/', 'blog/', 'contact.config'],
